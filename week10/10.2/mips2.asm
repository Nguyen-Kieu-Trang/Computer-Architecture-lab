...
goDOWN: addi $a0, $zero, 162 # Marsbot rotates 180*
 jal ROTATE
...
jal UNTRACK # keep old track
 jal TRACK # and draw new track line
goLEFT: addi $a0, $zero, 306 # Marsbot rotates 270* 
 jal ROTATE
...
goUP:addi $a0, $zero, 234 # Marsbot rotates 120* 
 jal ROTATE 
...
goUPs:addi $a0, $zero, 18 # Marsbot rotates 120* 
 jal ROTATE 
